...
<div class="shop-detail__wrapper">
    <div class="shop-detail__inner">
        <div class="shop-detail__block--left">
            ...
            <div class="shop-detail__detail">
                <img src="{{ $shop->image }}" alt="{{ $shop->shop_name }}" class="shop-detail__img">
                <div class="shop-tags">
        ...
        <div class="review__header">
            ...
            <div class="review__content__unit">
                ...
                <div class="review__content--links">
                    ...
                    @endcan
                    @can('delete', $myReview)
                    <form action="{{ route('review.destroy', ['review_id' => $myReview->id]) }}" method="POST" onsubmit="return confirm('本当に削除しますか？');">
                        @csrf
                        @method('DELETE')
                ...
                <div class="review__content__layout">
